...
namespace SAHL_Cancellations.Pages
{
    public class PropertyPage
    {
        ...
        public IWebElement PropertyTab => driver.FindElement(By.XPath("//div[contains(text(),'Property')]"));
        ...
        public IWebElement PropertyTypeDrpDwn => driver.FindElement(By.XPath("//select[@id='ctl00_ctl00_C_C_ddlPropertyType']"));
        public IWebElement SubDivisionalTypeDrpDwn => driver.FindElement(By.XPath("//select[@id='ctl00_ctl00_C_C_ddlSubdivisionalType']"));
        public IWebElement ErfNumberTxtBox => driver.FindElement(By.XPath("//input[@id='ctl00_ctl00_C_C_txtERFNo']"));
        public IWebElement TownshipTextBox => driver.FindElement(By.XPath("//input[@id='ctl00_ctl00_C_C_txtTownship']"));
        public IWebElement RegistrationDivisionTxtBox => driver.FindElement(By.XPath("//input[@id='ctl00_ctl00_C_C_txtRegistrationDivision']"));
        public IWebElement ProvinceDrpDwn => driver.FindElement(By.XPath("//select[@id='ctl00_ctl00_C_C_ddlProvince']"));
        public IWebElement ExtentTxtBox => driver.FindElement(By.XPath("//input[@id='ctl00_ctl00_C_C_txtExtentOfProperty']"));
        public IWebElement ExtentDrpDwn => driver.FindElement(By.XPath("//select[@id='ctl00_ctl00_C_C_txtVAR_MeasurmentUnit']"));
        ...
        public IWebElement LegalDescriptionTxtBox => driver.FindElement(By.XPath("//textarea[@id='ctl00_ctl00_C_C_txtPRP_LegalDescription']"));
        ...
        public IWebElement HeldByTextbox => driver.FindElement(By.XPath("//input[@id='ctl00_ctl00_C_C_txtHeldBy_TextBox1']"));
        public IWebElement PortionNumberTextBox => driver.FindElement(By.XPath("//input[@id='ctl00_ctl00_C_C_txtPortion_txtPortionTextBox']"));
