...
namespace SAHL_Cancellations.Pages
{
    public class AssistancePage
    {
        ...
        public AssistancePage(IWebDriver driver)
        {
            this.driver = driver;  // Assigning the driver to the class variable
        }

        // UI Elements - All elements on the HomePage
        public IWebElement RequestCancellationButton => driver.FindElement(By.XPath("//div[normalize-space()='Cancellations']"));
        ...
        {
            CancellationsTab.Click();  // Click on the "Request Cancellation" button
        }
    }
}
